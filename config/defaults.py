...
_C.DATASETS.ROOT_DIR = ('/data/wenjie/')
...
# ---------------------------------------------------------------------------- #
_C.ATTACK = CN()
_C.ATTACK.EPSILON = 0.1
_C.ATTACK.LEARNING_RATE = 0.00001
_C.ATTACK.MAX_ITER = 500
_C.ATTACK.U = 0.1
_C.ATTACK.SAT_CHANGE = 0.00001
_C.ATTACK.SAT = 0.1
_C.ATTACK.ATTACK_PATH='/home/wenjie/projects/reid-strong-baseline/attack.npy'
_C.ATTACK.ATTACK_WEIGHT='/home/wenjie/projects/reid_baseline/reid-strong-baseline/market_all_tricks-without_center/resnet50_model_120.pth'
_C.ATTACK.RATIO = 0.
_C.ATTACK.IS_ATTACK = False
