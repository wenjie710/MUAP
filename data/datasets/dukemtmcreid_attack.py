...
class DukeMTMCreID_attack(BaseImageDataset):
    """
    DukeMTMC-reID
    Reference:
    ...
    def __init__(self, root='/data1/wenjie/Datasets/image_reid/duke', verbose=True, **kwargs):
        super(DukeMTMCreID_attack, self).__init__()
        ...
        if verbose:
            print("=> DukeMTMC-reID attack loaded")
